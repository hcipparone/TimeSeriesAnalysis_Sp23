...
#This shows a strong autoregressive component in the ACF. All together bad. Residuals not around 0
```
...
#Much better than before. residual looks pretty random, ACF within dotted lines, residuals are normal distribution around 0 so pretty good
```
This is by far the best fit. Notice the residual series seems to be random and ACF shows no significant self correlation.

#All of this is backwards looking assessment
